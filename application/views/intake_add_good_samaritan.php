        ...
        $("#goodSamaritanForm").submit(function(event) {
            ...
            jQuery.ajax({
                ...
                if (res == "success" ) {
                    ...
                    jQuery("div#content").html('<div class="alert alert-success mt-6 col-3" role="alert">Successfully added ' + firstName + ' ' + lastName + '</div>');
                }
                else{
                    jQuery("div#content").html('<div class="alert alert-danger mt-6 col-3" role="alert">Failed to add ' + firstName + ' ' + lastName + '</div>');
                }
            },
                error: function(res) {
