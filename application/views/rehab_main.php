...
<div class="container-fluid mt-md-2 ml-2 border border-dark rounded" id="content" style="min-height: 500px; width: 98%">
    <div class="card-deck">
        <div class="card col-4" style="width: 20rem;">
            <img class="card-img-top" src="<?php echo base_url();?>/application/images/squirrel_1.jpg" alt="Card image cap" height="400" width="200">
            <div class="card-body">
        ...
        <div class="card col-4" style="width: 20rem;">
            <img class="card-img-top" src="<?php echo base_url();?>/application/images/possum.jpg" alt="Card image cap" height="400" width="200">
            <div class="card-body">
        ...
        <div class="card col-4" style="width: 20rem;">
            <img class="card-img-top" src="<?php echo base_url();?>/application/images/goat.jpg" alt="Card image cap" height="400" width="200">
            <div class="card-body">
