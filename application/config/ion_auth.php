 ...
 */
$config['site_title']                 = "NC WildLife Rehab";       // Site Title, example.com
...
$config['user_expire']                = 43200;               // How long to remember the user (seconds). Set to zero for no expiration - see sess_expiration in CodeIgniter Session Config for session expiration
